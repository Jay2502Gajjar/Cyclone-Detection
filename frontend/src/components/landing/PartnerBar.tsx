...
export function PartnerBar() {
  ...
  return (
    <section id="organizations" className="relative border-y border-white/[0.06] bg-white/[0.015] py-8 backdrop-blur-xl">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3.5 md:gap-5">
          {partners.map((partner) => {
            const Icon = partner.icon;
            return (
              <div
                key={partner.name}
                className="group flex items-center gap-2.5 rounded-full border border-white/[0.08] bg-white/[0.03] px-4.5 py-2 shadow-[0_4px_20px_0_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.08)] backdrop-blur-xl transition-all duration-300 hover:border-[#38BDF8]/50 hover:bg-white/[0.07] hover:shadow-[0_0_20px_rgba(56,189,248,0.25)] hover:-translate-y-0.5"
              >
